...
def callAdmin():
    while True:
        ...
        if ch == 1:
            ...
            srR = mycursor.fetchone()
            #print(srR)

            
            print("Technology: ",srR[2])
            print("Marks: ",srR[3])
            print("Date of Exam: ",srR[4])
            print("Status: ",srR[5])
...
def callStudent(user_id):
    while True:
        ...
        if ch == 1:
            ...
            mycursor.execute("insert into result(user_id,tech_id,marks,resdate,status)values('{}',{},{},'{}','{}')".format(user_id,tid,per,dates,ressta))
            mydb.commit()
...
"""
            ...
            #task 2
            mycursor.execute("select * from result".format())
            resprint = mycursor.fetchone()
            #print(resprint)
            print("Marks:- ",resprint[3],"/","100")
            print("Status:- ",resprint[5])
